...
# for sql_agent
RUN ./llm_py_env/bin/pip install --no-cache-dir gunicorn flask concurrent-log-handler langchain_openai langchain_ollama langchain_core langchain_community openai pandas tabulate pymysql sounddevice
RUN  rm -rf ~/.cache/pip
