...
SET DEFINE OFF;
Insert into TEST.ORDER_INFO (ID,"订单ID","省","公司名称","商品名称","年","创建时间","支付方式","支付金额","月") values (1,2233445,'广东','广东天然气体有限公司_orc','居民天然气',2025,'2025-04-10','昆仑惠享+','123456','4');
Insert into TEST.ORDER_INFO (ID,"订单ID","省","公司名称","商品名称","年","创建时间","支付方式","支付金额","月") values (2,3342567,'辽宁','辽宁天然气有限公司_orc','工商服务天然气',2024,'2024-05-01','对公转账','6658789','5');
--------------------------------------------------------
