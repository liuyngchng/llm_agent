...
def test_transcribe_wav_audio_file():
    ...
    """
    txt = transcribe_audio_file("../../common/static/asr_example_zh.wav", my_cfg)
...
def test_transcribe_webm_audio_file():
    ...
    for test purpose only
    """
    with open('../../common/static/asr_test.webm', 'rb') as f:
        audio_bytes = f.read()
