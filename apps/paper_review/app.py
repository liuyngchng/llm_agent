...
def register_routes(app):
    ...
    @app.route("/paper_review/gen", methods=['POST'])
    def gen_paper_review():
        """
        ...
        data = request.json
        uid = data.get("uid")
        logger.info(f"{uid}, gen_paper_review_dt, {data}")
        ...
        threading.Thread(
            target=fill_paper_review_with_txt,
...
def fill_paper_review_with_txt(uid: int, doc_type: str, doc_title: str, keywords: str, task_id: int, file_name: str):
    """
