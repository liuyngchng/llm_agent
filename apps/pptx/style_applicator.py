class StyleApplicator:
    ...
    def _redistribute_content(self, source_slide, target_slide, template_styles):
        ...
        # 智能匹配元素到占位符
        element_mapping = self._match_elements_to_placeholders(source_elements, target_placeholders)
    ...
    def _match_elements_to_placeholders(self, elements, placeholders):
        """匹配元素到占位符 - 简化实现"""
        mapping = {}
        # 简单的一对一匹配
    ...
    def _apply_paragraph_style(self, paragraph, template_styles):
        ...
        try:
            font = paragraph.font
            # 使用默认字体样式
            template_font = template_styles.get('font_styles', {}).get('default', {})
