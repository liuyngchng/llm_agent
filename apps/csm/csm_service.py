...
from common.agt_util import fill_dict, extract_session_info, update_session_info, get_abs_of_chat
...
class CsmService:
    ...
    def retrieval_data(self, answer: str, label: str, msg: str, uid: int, sys_cfg: dict) -> str:
        ...
        :param sys_cfg: the system config information
        """
        sql_agent = SqlAgent(sys_cfg, uid, f"{self.get_const_dict().get('str1')} {uid}")
