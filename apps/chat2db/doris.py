...
from common.cm_utils import adjust_html_table_columns
from common import cfg_util
from common.cfg_util import set_db_cache, get_db_cache, del_db_cache
from common.my_enums import DataType
from common.sys_init import init_yml_cfg
from common.db_util import DbUtl,DB_RW_TIMEOUT, DB_CONN_TIMEOUT
    ...
    def output_data(self, sql: str, data_format: str) -> str | LiteralString | None:
        try:
            ...
            if DataType.HTML.value in dt_fmt:
                ...
                dt = adjust_html_table_columns(dt)
